...
// 1. Variables and Data Types std means standard 
#include <stdio.h>
#include <stdbool.h>
#include <stddef.h> //standard defination header: provides size_t, ptrdiff_t , wchar_t for unsigned int, singned int, wide character type in unicode 
#include <string.h>
int main(){
    ...
    */
	...
	char myName = "Sujon" // this is actually: { 'S', 'u', 'j','o','n','\0'}

    strlen(myName); // length
	strlcat(str1, str2); // concatenate
